...
const ApplicationsPage = (props) => {
    ...
    useEffect(() => {
        const _getSchema = async () => {
            const _schema = await props.getSchema("applications");
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , applicant : urlParams.singleApplicantsId ,programme : urlParams.singleProgrammesId ,campus : urlParams.singleProgrammesId ,location : urlParams.singleProgrammesId ,programmeLevel : urlParams.singleProgrammesId ,intake : urlParams.singleProgrammesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="applications-add-button"/>
                    
                    </>
                </div>
            </div>
            <div className="grid align-items-center">
                <div className="col-11" role="applications-datatable">
...
/>            
      ...
      />
            ...
            <ApplicationsCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
