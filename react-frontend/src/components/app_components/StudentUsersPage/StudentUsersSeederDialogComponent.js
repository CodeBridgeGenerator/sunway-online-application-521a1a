...
import seederData from "./studentUsers.seeder.json";
...
const StudentUsersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(StudentUsersSeederDialogComponent);
