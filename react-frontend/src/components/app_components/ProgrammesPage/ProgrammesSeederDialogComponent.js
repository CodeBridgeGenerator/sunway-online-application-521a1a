...
import seederData from "./programmes.seeder.json";
...
const ProgrammesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProgrammesSeederDialogComponent);
