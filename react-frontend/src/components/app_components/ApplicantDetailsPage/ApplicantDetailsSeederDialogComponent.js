...
import seederData from "./applicantDetails.seeder.json";
...
const ApplicantDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ApplicantDetailsSeederDialogComponent);
