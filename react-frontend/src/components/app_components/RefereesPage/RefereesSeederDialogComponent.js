...
import seederData from "./referees.seeder.json";
...
const RefereesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RefereesSeederDialogComponent);
