...
import SingleStudentUsersPage from "../components/app_components/StudentUsersPage/SingleStudentUsersPage";
import StudentUserProjectLayoutPage from "../components/app_components/StudentUsersPage/StudentUserProjectLayoutPage";
import SingleApplicantDetailsPage from "../components/app_components/ApplicantDetailsPage/SingleApplicantDetailsPage";
import ApplicantDetailProjectLayoutPage from "../components/app_components/ApplicantDetailsPage/ApplicantDetailProjectLayoutPage";
...
import SingleProgrammesPage from "../components/app_components/ProgrammesPage/SingleProgrammesPage";
import ProgrammeProjectLayoutPage from "../components/app_components/ProgrammesPage/ProgrammeProjectLayoutPage";
import SingleContactDetailsPage from "../components/app_components/ContactDetailsPage/SingleContactDetailsPage";
import ContactDetailProjectLayoutPage from "../components/app_components/ContactDetailsPage/ContactDetailProjectLayoutPage";
import SingleRefereesPage from "../components/app_components/RefereesPage/SingleRefereesPage";
import RefereeProjectLayoutPage from "../components/app_components/RefereesPage/RefereeProjectLayoutPage";
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/studentUsers/:singleStudentUsersId" exact element={<SingleStudentUsersPage />} />
<Route path="/studentUsers" exact element={<StudentUserProjectLayoutPage />} />
<Route path="/applicantDetails/:singleApplicantDetailsId" exact element={<SingleApplicantDetailsPage />} />
<Route path="/applicantDetails" exact element={<ApplicantDetailProjectLayoutPage />} />
...
<Route path="/programmes/:singleProgrammesId" exact element={<SingleProgrammesPage />} />
<Route path="/programmes" exact element={<ProgrammeProjectLayoutPage />} />
<Route path="/contactDetails/:singleContactDetailsId" exact element={<SingleContactDetailsPage />} />
<Route path="/contactDetails" exact element={<ContactDetailProjectLayoutPage />} />
<Route path="/referees/:singleRefereesId" exact element={<SingleRefereesPage />} />
<Route path="/referees" exact element={<RefereeProjectLayoutPage />} />
