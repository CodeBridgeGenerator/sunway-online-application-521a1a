...
const studentUsers = require("./studentUsers/studentUsers.service.js");
const applicantDetails = require("./applicantDetails/applicantDetails.service.js");
const applications = require("./applications/applications.service.js");
const programmes = require("./programmes/programmes.service.js");
...
module.exports = function (app) {
  ...
  app.configure(studentUsers);
  app.configure(applicantDetails);
